...
class ProcessPointCloud:
    ...
    def __init__(self, pcd_file, nrows_value, display_output_flag):
        ...
        if pcd_file.endswith(".pcd"):
            pcd = o3d.io.read_point_cloud(r"/Users/seaside/Desktop/【第02部分 三维点云专题】三位建模感知与点云视频教程 5套/03.2020年3D感知技术培训视频教程（附代码、讲义、参考资料）49课/00.配套资料（代码、讲义、作业、参考文献）/00.配套资料（代码、讲义、作业、参考文献）/03.3D数据表示和转换/CH3-HW/kdtree/point_cloud_data_sample_2.pcd")
